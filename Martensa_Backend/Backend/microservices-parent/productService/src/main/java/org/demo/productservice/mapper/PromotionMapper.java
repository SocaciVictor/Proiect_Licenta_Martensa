...
public interface PromotionMapper {
    ...
    @Mapping(target = "productIds", expression = "java(promotion.getProducts() != null ? promotion.getProducts().stream().map(product -> product.getId()).toList() : java.util.Collections.emptyList())")
